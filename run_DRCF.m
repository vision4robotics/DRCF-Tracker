...
% Learning parameters
params.output_sigma_factor = 0.062;		% Label function sigma

% ADMM parameters
params.max_iterations = [2 2];             %3,4,5
...
params.scale_step = 1.0385;               % Scale increment factor (denoted "a" in the paper)
